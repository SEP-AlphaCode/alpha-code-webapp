...
export const courses: Course[] = [
  {
    ...
    lessons: [
      {
        id: "l-rf1-1", sectionId: "rf-1", title: "Robotics là gì?",
      ...
      {
        id: "l-rf1-2", sectionId: "rf-1", title: "Lịch sử Robotics",
      ...
      {
        id: "l-rf1-3", sectionId: "rf-1", title: "Các loại Robot",
      ...
      {
        id: "l-rf1-4", sectionId: "rf-1", title: "Thành phần Cơ bản của Robot",
        requireRobot: false,
        duration: 2400, content: "Cảm biến, cơ cấu chấp hành, bộ điều khiển",
        contentType: "text", orderNumber: 4, solution: null
      },
      {
        id: "l-rf1-5", sectionId: "rf-1", title: "Ứng dụng của Robot",
      ...
      {
        id: "l-rf1-6", sectionId: "rf-1", title: "Nguyên tắc An toàn Cơ bản",
        requireRobot: false,
        duration: 1800, content: "Giao thức và thực hành an toàn",
        contentType: "text", orderNumber: 6, solution: null
      },
      {
        id: "l-rf1-7", sectionId: "rf-1", title: "Lập trình Cơ bản",
      ...
      {
        id: "l-rf1-8", sectionId: "rf-1", title: "Bài tập Robot Đầu tiên",
        requireRobot: true,
      ...
      {
        id: "l-rf1-9", sectionId: "rf-1", title: "Xử lý Sự cố Cơ bản",
      ...
      {
        id: "l-rf1-10", sectionId: "rf-1", title: "Xu hướng Ngành",
        requireRobot: false,
        duration: 2100, content: "Xu hướng robotics hiện tại",
        contentType: "text", orderNumber: 10, solution: null
      },
      {
        id: "l-rf1-11", sectionId: "rf-1", title: "Thiết lập Dự án Cuối khóa",
        requireRobot: true,
      ...
      {
        id: "l-rf1-12", sectionId: "rf-1", title: "Ôn tập Khóa học",
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "l-rp1-4", sectionId: "rp-1", title: "Xử lý Dữ liệu Cảm biến", 
        requireRobot: true, 
      ...
      {
        id: "l-rp1-5", sectionId: "rp-1", title: "Lập trình Hướng đối tượng", 
        contentUrl: "/content/rp1/lesson5.mp4", requireRobot: false, 
        duration: 3600, content: "Lớp và đối tượng cho robot", 
        contentType: "video", orderNumber: 5, solution: null
      },
      {
        id: "l-rp1-6", sectionId: "rp-1", title: "Triển khai Lớp Robot", 
        requireRobot: true, 
      ...
      {
        id: "l-rp1-9", sectionId: "rp-1", title: "Tích hợp API", 
        requireRobot: false, 
      ...
      {
        id: "l-rp1-10", sectionId: "rp-1", title: "Trực quan hóa Dữ liệu", 
      ...
      {
        id: "l-rp1-11", sectionId: "rp-1", title: "Thuật toán Nâng cao", 
        requireRobot: true, 
      ...
      {
        id: "l-rp1-12", sectionId: "rp-1", title: "Kiểm thử Mã Robot", 
        requireRobot: false, 
        duration: 2400, content: "Kiểm thử đơn vị cho robotics", 
        contentType: "text", orderNumber: 12, solution: null
      },
      {
        id: "l-rp1-13", sectionId: "rp-1", title: "Tối ưu hóa Hiệu suất", 
      ...
      {
        id: "l-rp1-14", sectionId: "rp-1", title: "Dự án Cuối: Robot Tự hành", 
        requireRobot: true, 
  ...
  },
  {
    ...
    lessons: [
      {
        id: "l-ir1-1", sectionId: "ir-1", title: "Tiêu chuẩn An toàn Công nghiệp", 
        contentUrl: "/content/ir1/lesson1.mp4", requireRobot: false, 
        duration: 3600, content: "Giao thức an toàn cho robot công nghiệp", 
        contentType: "video", orderNumber: 1, solution: null
      },
      {
        id: "l-ir1-2", sectionId: "ir-1", title: "Giao diện Robot FANUC", 
        requireRobot: true, 
      ...
      {
        id: "l-ir1-3", sectionId: "ir-1", title: "Tổng quan Hệ thống KUKA", 
      ...
      {
        id: "l-ir1-4", sectionId: "ir-1", title: "ABB RobotStudio", 
        requireRobot: true, 
      ...
      {
        id: "l-ir1-5", sectionId: "ir-1", title: "Lập kế hoạch Đường đi", 
      ...
      {
        id: "l-ir1-6", sectionId: "ir-1", title: "Tính toán Tải trọng", 
        requireRobot: false, 
        duration: 3000, content: "Tính toán khả năng tải robot", 
        contentType: "text", orderNumber: 6, solution: null
      },
      {
        id: "l-ir1-7", sectionId: "ir-1", title: "Thiết lập Điểm Tâm Công cụ", 
      ...
      {
        id: "l-ir1-8", sectionId: "ir-1", title: "Tích hợp I/O", 
        requireRobot: true, 
      ...
      {
        id: "l-ir1-9", sectionId: "ir-1", title: "Xử lý Lỗi", 
      ...
      {
        id: "l-ir1-10", sectionId: "ir-1", title: "Quy trình Bảo trì", 
        requireRobot: false, 
        duration: 2400, content: "Bảo trì phòng ngừa", 
        contentType: "text", orderNumber: 10, solution: null
      },
      {
        id: "l-ir1-11", sectionId: "ir-1", title: "Lập trình Nâng cao", 
      ...
      {
        id: "l-ir1-12", sectionId: "ir-1", title: "Kiểm soát Chất lượng", 
        requireRobot: true, 
  ...
  },
  {
    ...
    lessons: [
      {
        id: "l-as1-1", sectionId: "as-1", title: "Giới thiệu Hệ thống Tự hành", 
        contentUrl: "/content/as1/lesson1.mp4", requireRobot: false, 
        duration: 2400, content: "Tổng quan về định vị tự hành", 
        contentType: "video", orderNumber: 1, solution: null
      },
      {
        id: "l-as1-2", sectionId: "as-1", title: "Hợp nhất Cảm biến", 
        requireRobot: true, 
      ...
      {
        id: "l-as1-3", sectionId: "as-1", title: "Thuật toán SLAM", 
      ...
      {
        id: "l-as1-4", sectionId: "as-1", title: "Lập kế hoạch Đường đi", 
        requireRobot: true, 
      ...
      {
        id: "l-as1-5", sectionId: "as-1", title: "Tránh Chướng ngại vật", 
      ...
      {
        id: "l-as1-6", sectionId: "as-1", title: "Học máy cho Định vị", 
        requireRobot: true, 
      ...
      {
        id: "l-as1-7", sectionId: "as-1", title: "ROS Navigation Stack", 
      ...
      {
        id: "l-as1-8", sectionId: "as-1", title: "Phối hợp Đa Robot", 
        requireRobot: true, 
      ...
      {
        id: "l-as1-9", sectionId: "as-1", title: "Hệ thống Thời gian Thực", 
      ...
      {
        id: "l-as1-10", sectionId: "as-1", title: "Kiểm thử và Xác nhận", 
        requireRobot: false, 
        duration: 3600, content: "Kiểm thử hệ thống tự hành", 
        contentType: "text", orderNumber: 10, solution: null
      },
      {
        id: "l-as1-11", sectionId: "as-1", title: "Nghiên cứu Tình huống: Xe Tự lái", 
      ...
      {
        id: "l-as1-12", sectionId: "as-1", title: "Dự án Cuối khóa", 
        requireRobot: true, 
  ...
  },
  {
    ...
    lessons: [
      {
        id: "l-hr1-1", sectionId: "hr-1", title: "Giới thiệu Robotics Xã hội", 
        contentUrl: "/content/hr1/lesson1.mp4", requireRobot: false, 
        duration: 1800, content: "Điều gì tạo nên một robot xã hội", 
        contentType: "video", orderNumber: 1, solution: null
      },
      {
        id: "l-hr1-2", sectionId: "hr-1", title: "Nguyên tắc Tương tác Người-Máy", 
        requireRobot: false, 
        duration: 2400, content: "Nguyên tắc thiết kế HRI", 
        contentType: "text", orderNumber: 2, solution: null
      },
      {
        id: "l-hr1-3", sectionId: "hr-1", title: "Thiết kế Biểu cảm Khuôn mặt", 
      ...
      {
        id: "l-hr1-4", sectionId: "hr-1", title: "Tương tác Giọng nói", 
        requireRobot: true, 
      ...
      {
        id: "l-hr1-5", sectionId: "hr-1", title: "Nhận dạng Cử chỉ", 
      ...
      {
        id: "l-hr1-6", sectionId: "hr-1", title: "AI Cảm xúc", 
        requireRobot: true, 
      ...
      {
        id: "l-hr1-7", sectionId: "hr-1", title: "Định vị Xã hội", 
      ...
      {
        id: "l-hr1-11", sectionId: "hr-1", title: "Nghiên cứu Tình huống: Robot Pepper", 
        contentUrl: "/content/hr1/lesson11.mp4", requireRobot: false, 
        duration: 4200, content: "Phân tích robot xã hội thương mại", 
        contentType: "video", orderNumber: 11, solution: null
      },
      {
        id: "l-hr1-12", sectionId: "hr-1", title: "Dự án Cuối: Robot Xã hội", 
        requireRobot: true, 
  ...
  },
  {
    ...
    lessons: [
      {
        id: "l-rs1-1", sectionId: "rs-1", title: "Cài đặt Gazebo", 
        contentUrl: "/content/rs1/lesson1.mp4", requireRobot: false, 
        duration: 2400, content: "Cài đặt và cấu hình Gazebo", 
        contentType: "video", orderNumber: 1, solution: null
      },
      {
        id: "l-rs1-2", sectionId: "rs-1", title: "Xây dựng Thế giới Cơ bản", 
        requireRobot: false, 
      ...
      {
        id: "l-rs1-3", sectionId: "rs-1", title: "Tạo Mô hình Robot", 
      ...
      {
        id: "l-rs1-4", sectionId: "rs-1", title: "Tệp URDF", 
        requireRobot: false, 
      ...
      {
        id: "l-rs1-5", sectionId: "rs-1", title: "Mô phỏng Cảm biến", 
      ...
      {
        id: "l-rs1-6", sectionId: "rs-1", title: "Công cụ Vật lý", 
        requireRobot: false, 
        duration: 3600, content: "Công cụ vật lý ODE, Bullet", 
        contentType: "text", orderNumber: 6, solution: null
      },
      {
        id: "l-rs1-7", sectionId: "rs-1", title: "Tích hợp ROS", 
      ...
      {
        id: "l-rs1-8", sectionId: "rs-1", title: "Phát triển Plugin", 
        requireRobot: false, 
      ...
      {
        id: "l-rs1-9", sectionId: "rs-1", title: "Môi trường Nâng cao", 
      ...
      {
        id: "l-rs1-10", sectionId: "rs-1", title: "Tối ưu hóa Hiệu suất", 
        requireRobot: false, 
      ...
      {
        id: "l-rs1-11", sectionId: "rs-1", title: "Dự án Cuối: Mô phỏng Robot Hoàn chỉnh", 
        requireRobot: false, 
