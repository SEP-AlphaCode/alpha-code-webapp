...
import { getPagedSkills } from "@/features/activities/api/skill-api"
...
function SkillsPage() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["skills", page, size, debouncedSearchTerm],
    ...
    <div className="container mx-auto py-10">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold">Quản lý kĩ năng</h1>
          <Button
      ...
      <DataTable
        ...
        searchPlaceholder="Tìm kiếm kĩ năng..."
