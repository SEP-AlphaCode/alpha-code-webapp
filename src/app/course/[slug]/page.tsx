...
export default function CourseHomePage() {
  ...
  const handleConfirmRegister = async () => {
    ...
    try {
      ...
      router.push(`/parent/courses/learning/${courseData!.slug}`);
    } catch (err) {
        ...
        <Dialog open={isLoginDialogOpen} onOpenChange={setIsLoginDialogOpen}>
          <DialogContent className="sm:max-w-lg p-0 overflow-hidden">
            <div className="relative">
              {/* Image Section */}
              <div className="w-full h-48 sm:h-56 bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center overflow-hidden">
                <img 
                  src="/img_signup.webp" 
                  alt="Login Required" 
              ...
              <div className="p-6 sm:p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Vui lòng <span className="font-semibold text-orange-500">đăng nhập</span> để đăng ký khóa học này
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <Button 
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-6 text-lg rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Đăng nhập
                  </Button>
