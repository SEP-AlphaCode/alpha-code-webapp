        ...
        <h1 className="text-3xl font-bold text-[var(--foreground)]">{t.header.title}</h1>
                            ...
                            {selectedRobotDetails ? (
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-semibold text-left block">{selectedRobotDetails.name}</span>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6" suppressHydrationWarning>
                    <Card className="p-6 text-center cursor-pointer bg-white text-[var(--card-foreground)] shadow-lg hover:scale-105 transition-transform border border-[var(--border)]" suppressHydrationWarning>
                    ...
                    <Card className="p-6 text-center cursor-pointer bg-gray-100 text-[var(--card-foreground)] shadow-lg hover:scale-105 transition-transform border border-[var(--border)]" suppressHydrationWarning>
                        <CardHeader className="flex items-center justify-center">
                    ...
                    <Card className="p-6 text-center cursor-pointer bg-blue-100 text-[var(--card-foreground)] shadow-lg hover:scale-105 transition-transform border border-[var(--border)]" suppressHydrationWarning>
                        <CardHeader className="flex items-center justify-center">
                            <div className="text-4xl">🎨</div>
                        </CardHeader>
                        <CardContent>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6" suppressHydrationWarning>
                    ...
                    <Card className="p-6 text-center cursor-pointer bg-blue-400 text-[var(--card-foreground)] shadow-lg hover:scale-105 transition-transform border border-[var(--border)]" suppressHydrationWarning>
                        <CardHeader className="flex items-center justify-center">
                            <div className="text-4xl">🖼️</div>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="p-6 text-center cursor-pointer bg-yellow-400 text-[var(--card-foreground)] shadow-lg hover:scale-105 transition-transform border border-[var(--border)]" suppressHydrationWarning>
                        <CardHeader className="flex items-center justify-center">
                            <div className="text-4xl">🤝</div>
                        </CardHeader>
                        <CardContent>
