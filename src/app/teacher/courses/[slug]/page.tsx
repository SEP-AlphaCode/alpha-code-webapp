...
export default function CoursePage() {
  ...
  if (isLoading)
    return (
      <div className="space-y-6 p-4 md:p-6 lg:p-10 min-h-screen" suppressHydrationWarning>
        <div className="max-w-7xl mx-auto">
          {/* Breadcrumb Skeleton */}
          <div className="mb-6">
            <div className="h-4 bg-slate-300 rounded w-48 mb-2 animate-pulse"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="space-y-6">
              <div className="h-64 bg-slate-300 rounded-lg animate-pulse"></div>
              <div className="h-12 bg-slate-300 rounded animate-pulse"></div>
      ...
      >
        <div className="text-center max-w-md bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-red-200">
          ...
          <button
            ...
            className="px-6 md:px-8 py-3 md:py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-sm md:text-base"
          >
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white p-5 md:p-6 rounded-xl shadow-md border border-orange-200 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                ...
                <p className={cn("font-bold text-xl md:text-2xl", diff.color)}>{diff.text}</p>
              </div>
            </section>
