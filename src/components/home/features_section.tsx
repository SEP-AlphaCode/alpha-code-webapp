...
import { Zap, Brain, Heart, Sparkles, Shield, Lightbulb, ChevronDown } from "lucide-react"
...
const features = [
  ...
  },
  {
    ...
    description: "Phản hồi nhanh chóng, tiết kiệm thời gian, tối ưu hiệu suất công việc với công nghệ AI tiên tiến.",
    color: "purple",
  ...
  },
  {
    ...
    description: "Thiết kế tối giản, dễ sử dụng, phù hợp mọi đối tượng người dùng với trải nghiệm tuyệt vời.",
    color: "green",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Khám phá những tính năng đặc biệt giúp Alpha Mini trở thành người bạn đồng hành lý tưởng
            </p>
          </div>
        ...
        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="flex flex-col items-center gap-1 sm:gap-2 animate-bounce">
            <span className="text-gray-500 text-xs sm:text-sm hidden sm:block">Cuộn xuống</span>
