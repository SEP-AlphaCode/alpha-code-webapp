        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Khám phá Alpha Mini với thiết kế tiên tiến, AI thông minh và khả năng tương tác tự nhiên
            </p>
          </div>
                ...
                <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105">
                  ...
                  <div className="absolute top-2 sm:top-3 left-2 sm:left-3 bg-white/90 backdrop-blur-sm rounded-md sm:rounded-lg px-1.5 sm:px-2 py-1 shadow-md">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs font-medium text-gray-700 hidden sm:inline">Bảo mật AI</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-md sm:rounded-lg p-2 sm:p-3 shadow-md border border-gray-200">
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-600 hidden sm:block">Robot AI thông minh</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105">
                  ...
                  <div className="absolute top-2 sm:top-3 right-2 sm:right-3 bg-white/90 backdrop-blur-sm rounded-md sm:rounded-lg px-1.5 sm:px-2 py-1 shadow-md">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs font-medium text-gray-700 hidden sm:inline">Tương tác AI</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="text-center group">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Bảo mật thông minh</h3>
              <p className="text-gray-600 text-xs sm:text-sm px-2">Hệ thống bảo mật AI tiên tiến, đảm bảo an toàn tuyệt đối</p>
            </div>
            <div className="text-center group">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">AI thông minh</h3>
              <p className="text-gray-600 text-xs sm:text-sm px-2">Học hỏi và thích ứng với thói quen sử dụng của bạn</p>
            </div>
            <div className="text-center group sm:col-span-2 md:col-span-1">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Tương tác tự nhiên</h3>
              <p className="text-gray-600 text-xs sm:text-sm px-2">Giao tiếp bằng giọng nói và cử chỉ như con người</p>
            </div>
          </div>
        </div>
      </section>
