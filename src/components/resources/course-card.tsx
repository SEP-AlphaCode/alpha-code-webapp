        ...
        <div className="flex-1">
          ...
          <div className="mt-4 grid gap-3">
            <div className="flex items-center justify-between bg-gray-50 p-3 rounded">
              ...
              <Link href="/courses" className="px-3 py-1 bg-indigo-600 text-white rounded text-sm hover:bg-indigo-700 transition">Đăng ký ngay</Link>
            </div>
          ...
          <div className="mt-4">
            <Link href="/courses" className="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm hover:bg-indigo-700 transition">Xem toàn bộ lộ trình học</Link>
          </div>
        </div>
      </div>
    </article>
